...
public:
	...
	{
		m_id = 1;
		if (!m_texture.loadFromFile("assets/argot/assets/powerUps/noDamage.png", m_renderer, 1))
		{
...
public:
	...
	{
		m_id = 2;
		if (!m_texture.loadFromFile("assets/argot/assets/powerUps/Speed.png", m_renderer, 1))
		{
...
public:
	...
	{
		m_id = 3;
		if (!m_texture.loadFromFile("assets/argot/assets/powerUps/projectile.png", m_renderer, 1))
		{
			printf("Failed to load dot texture!\n");
...
public:
	...
	{
		m_id = 4;
		if (!m_texture.loadFromFile("assets/argot/assets/powerUps/seekerprojectile.png", m_renderer, 1))
		{
			printf("Failed to load dot texture!\n");
...
public:
	...
	{
		m_id = 5;
		if (!m_texture.loadFromFile("assets/argot/assets/powerUps/noScore.png", m_renderer, 1))
		{
