...
void Game::initialise()
{
	...
	player3.addComponent(new SpriteComponent("img/playerSheet.png", 0.3, m_renderer));
	...
	player4.addComponent(new SpriteComponent("img/playerSheet.png", 0.3, m_renderer));
